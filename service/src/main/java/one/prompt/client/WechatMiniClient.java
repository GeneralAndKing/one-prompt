...
import one.prompt.model.exception.WechatException;
...
import static one.prompt.model.constant.ApplicationCache.Wechat.MINI_ACCESS_TOKEN;
import static one.prompt.model.constant.ApplicationCache.Wechat.MINI_AUTH_CODE;
import static one.prompt.model.constant.WechatInfo.Mini.*;
...
public class WechatMiniClient {
  ...
  public String getAccessToken() {
    ...
    String targetUri = UriComponentsBuilder.fromHttpUrl(WechatInfo.GET_ACCESS_TOKEN.url())
